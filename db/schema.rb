...
ActiveRecord::Schema.define(version: 2019_08_26_160952) do
  ...
  create_table "board_positions_combatants_players_matches", id: false, force: :cascade do |t|
  ...
  create_table "combatants_players_matches_match_turns", id: false, force: :cascade do |t|
    t.bigint "combatants_players_match_id", null: false
    t.bigint "match_turn_id", null: false
  ...
  create_table "combatants_players_matches_moves", id: false, force: :cascade do |t|
    t.bigint "combatants_players_match_id", null: false
  ...
  create_table "match_turns_move_turns", id: false, force: :cascade do |t|
    t.bigint "match_turn_id", null: false
